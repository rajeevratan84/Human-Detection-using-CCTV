                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <!-- <div class="form-group <?php echo (!empty($address_err)) ? 'has-error' : ''; ?>">-->
                            <!--<textarea name="address" class="form-control"><?php echo $weekday_on_time; ?></textarea>-->

                            <label for="weekday_on_time">What time to turn on your Alarm on Weekdays?</label>
                            <select id="weekday_on_time" name="weekday_on_time">
                        ...
                        <input type="submit" class="btn btn-primary pull-right" <?php echo $weekday_on_time; ?> value="Submit">
