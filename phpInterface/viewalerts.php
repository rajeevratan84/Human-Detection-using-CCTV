            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <h1><b>View Your Alarm Alerts</b></h1>
                        <a href="disarm.php" class="btn btn-success">Disable/Enable Alarm</a>
                        <a href="change_schedule.php" class="btn btn-success">Change Alarm Schedule</a>
                        <a href="draw_box.php" class="btn btn-success">Edit Region of Interest</a>
                    ...
                    $sql = "SELECT * FROM customer_alerts  WHERE customer_id = '{$_SESSION['id']}' ORDER BY time_of_event DESC LIMIT 100;";
